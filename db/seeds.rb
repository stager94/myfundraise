...
categories = Category.create [{ title: "Медицина", full_title: "Medical, Illness & Healing", slug: "medical",
																...
																popular: true, foto: File.open(generate_foto_path('categories/cardiogram.png'))
															},
															{ title: "Волонтерство", full_title: "Volunteer & Service", slug: "volunteer",
																...
																popular: true, foto: File.open(generate_foto_path('categories/volunteer.png'))
															},
															{ title: "Чрезвычайные ситуации", full_title: "Accidents & Emergencies", slug: "emergencies",
																...
																popular: true, foto: File.open(generate_foto_path('categories/alarm.png'))
															},
															{ title: "События", full_title: "Celebrations & Events", slug: "events",
																...
																popular: true, foto: File.open(generate_foto_path('categories/gift.png'))
															},
															{ title: "Образование", full_title: "Education & Learning", slug: "education",
																...
																popular: true, foto: File.open(generate_foto_path('categories/mortarboard.png'))
															},
															{ title: "Мемориалы", full_title: "Funerals & Memorials", slug: "memorials",
																...
																popular: true, foto: File.open(generate_foto_path('categories/gate.png'))
															},
															{ title: "Бизнес", full_title: "Business & Entrepreneurs", slug: "business",
																...
																popular: false, foto: File.open(generate_foto_path('categories/deal.png'))
															},
															{ title: "Фонды", full_title: "Non-Profits & Charities", slug: "charity",
																...
																popular: false, foto: File.open(generate_foto_path('categories/heart.png'))
															},
															{ title: "Сообщество", full_title: "Community & Neighbors", slug: "community",
																...
																popular: false, foto: File.open(generate_foto_path('categories/connection.png'))
															},
															{ title: "Соревнования", full_title: "Competitions & Pageants", slug: "competition",
																...
																popular: false, foto: File.open(generate_foto_path('categories/medal.png'))
															},
															{ title: "Творчество", full_title: "Creative Arts, Music & Film", slug: "creative",
																...
																popular: false, foto: File.open(generate_foto_path('categories/brainstorm.png'))
															},
															{ title: "Семейные", full_title: "Babies, Kids & Family", slug: "family",
																...
																popular: false, foto: File.open(generate_foto_path('categories/motherhood.png'))
															},
															{ title: "Молодожены", full_title: "Weddings & Honeymoons", slug: "newlyweds",
																...
																popular: false, foto: File.open(generate_foto_path('categories/wedding-couple.png'))
															},

															{ title: "Путешествия", full_title: "Travel & Adventure", slug: "travel",
																description: "Raise money for honeymoons, bridal registries, wedding ceremonies, and more!",
																popular: false, foto: File.open(generate_foto_path('categories/travel.png'))
															},
															{ title: "Пожелания", full_title: "Dreams, Hopes & Wishes", slug: "wishes",
																...
																popular: false, foto: File.open(generate_foto_path('categories/star.png'))
															},
															{ title: "Другие", full_title: "Other", slug: "other",
																...
																popular: false, foto: File.open(generate_foto_path('categories/paper-plane.png'))
															}]
